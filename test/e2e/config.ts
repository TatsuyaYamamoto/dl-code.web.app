export default {
  TEST_PRODUCT: {
    name: "e2e test content",
    description: `==== 変更禁止 =====
とってもとっても長いタイトルで改行を余儀なくされている
=================

https://www.google.com/search?q=hogehoge&oq=hogehoge&aqs=chrome..69i57j69i60j0l4.1090j0j4&sourceid=chrome&ie=UTF-8
